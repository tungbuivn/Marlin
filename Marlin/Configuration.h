...
//#define STRING_CONFIG_H_AUTHOR "(ET4X)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -6, -3.956 }
...
//#define LCD_PINS_D6 XXXX
//#define LCD_PINS_D7 XXXX
//lcd_sck, uint8_t mosi, uint8_t cs, uint8_t a0, uint8_t reset = U8G_PIN_NONE) {
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BKGD_COLOR { 255, 127, 0, 0 }  // R, G, B, W
